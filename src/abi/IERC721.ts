[
  ...
  { inputs: [], name: 'InvalidMintModuleData', type: 'error' },
  { inputs: [], name: 'InvalidRoyalty', type: 'error' },
  { inputs: [], name: 'MintERC2309QuantityExceedsLimit', type: 'error' },
  { inputs: [], name: 'MintToZeroAddress', type: 'error' },
  { inputs: [], name: 'MintZeroQuantity', type: 'error' },
  { inputs: [], name: 'ModuleUpdateFailed', type: 'error' },
  { inputs: [], name: 'NewOwnerIsZeroAddress', type: 'error' },
  { inputs: [], name: 'NoHandoverRequest', type: 'error' },
  { inputs: [], name: 'OnlyEOAAdminMintAllowed', type: 'error' },
  ...
  { inputs: [], name: 'UnapprovedMintModule', type: 'error' },
  ...
  {
    inputs: [{ internalType: 'address', name: 'mintModule', type: 'address' }],
    name: 'addMintModule',
    outputs: [],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'mintModuleRegistry_', type: 'address' },
      {
        internalType: 'contract IMetadataRenderer',
        name: '_metadataRenderer',
        type: 'address',
      },
      { internalType: 'bytes', name: 'metadataRendererConfig', type: 'bytes' },
      { internalType: 'address[]', name: 'mintModules', type: 'address[]' },
      { internalType: 'bytes[]', name: 'mintModuleData', type: 'bytes[]' },
  ...
  {
    inputs: [
      { internalType: 'address[]', name: 'configurable', type: 'address[]' },
